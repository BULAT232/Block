...
"use strict";for(var $=jQuery.noConflict(),coll=($(function(){$(".header__menu").click(function(e){$(".header__menu, .header__nav").toggleClass("active"),$("body").toggleClass("lock")}),$(".header__search").click(function(e){$(".header__search, .form").toggleClass("active"),$("body").toggleClass("lock")})}),document.getElementsByClassName("collapsible")),i=0;i<coll.length;i++)coll[i].addEventListener("click",function(){this.classList.toggle("active");var e=this.nextElementSibling;e.style.maxHeight?e.style.maxHeight=null:e.style.maxHeight=e.scrollHeight+"px"});
